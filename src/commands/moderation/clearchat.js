...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    if (jumlah.toLowerCase() === "all") {
      ...
      return interaction.editReply(`Successfully deleted ${deleted} messages.`);
    }
    ...
    if (isNaN(amount)) {
      return interaction.editReply("Please enter a valid number or use `all`.");
    }

    if (amount < 1 || amount > 1000) {
      return interaction.editReply("The number must be between 1 and 1000.");
    }
